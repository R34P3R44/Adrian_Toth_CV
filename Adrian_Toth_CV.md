...
| A 3D first person shooter micro game built with Unity engine using C# language.<br>Some of the interesting features of the game include 5 different custom built door<br>animations, upgraded weapons, enemies will not only feel realstic in terms of the<br>damage delt by them but also in movement and adaptation to the player.<br>The game itself is still in<br>progress but this is only including some final touches like post-processing<br>and testing. The initial date of completion is planned for 14.03.2021.|
