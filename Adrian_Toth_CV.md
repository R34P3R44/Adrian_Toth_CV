...
| Uptodate is an app that can help us stay organised with our expriation dates. The<br> inspiration is coming from one of my previous jobs where I was dealing with loads of<br> expiration date checks of different food items. Some of the products had quite a long<br> shelflife therefore I thought its pointless to check them each week, instead of that I can<br> make an app that can scan a date format using OCR technology.<br> When the scan is done the app will set up a reminder in my iOS calendar which will<br> tell me when that product is expiriing. These reminders can be amended therefore<br> I can set up different time frames if needed.  | <div align="center">Swift, C</div>
