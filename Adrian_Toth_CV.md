...
|-------------------------------------------------------------------------------------------------------------------------------|
| A webapp that allows visitors to post and book properties for stay. You can register and sign in or out, without an account the ads can be<br>only viewed on the website. Multiple properties can be added to the hosts profiles. Homeowners can set the price, availability and add a<br>brief description to their ads.|
