...
|--------------------------------------------------------------------------------------------|----------------------------------|
| A webapp that allows visitors to post and book properties for stay. You can<br>register and sign in or out, without an account the ads can be only viewed<br>on the website. Multiple properties can be added to the host's<br>profiles. Homeowners can set the price, availability and add a brief<br>description to their ads.|
