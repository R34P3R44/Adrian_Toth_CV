...
| A 3D first person shooter micro game built with Unity engine using C# language.<br>Some of the interesting features of the game include 5 different custom built door<br>animations, upgraded weapons, enemies will not only feel realstic in terms of the<br>damage delt by them but also in movement and adaptation to the player. The game<br>itself is still in progress but this is only including some final touches like post-processing<br>and testing. The initial date of completion was planned for April although I have decided<br>to tweak up the game a little more so a couple of other things will be added to enhance the experience. | <div align="center">C#, Unity game engine v 2019.04.16f1</div>
