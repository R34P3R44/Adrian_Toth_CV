...
|One of the first challenges of Maker Academy emphasising on the basic principles like<br>OOP, encapsulation and SRP. The famous bike renting app copycat that lets people hire<br>and return bikes. Each station has a maximum capacity of bikes and<br>checks if the bike is still working. Broken bikes will be accepted at all stations but wont be released until it is fixed.  | Ruby, RSpec |
